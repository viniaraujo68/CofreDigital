...
public class CadastroAdminPanel extends JPanel {
    ...
    public CadastroAdminPanel(ActionListener onCadastrar, ActionListener onVoltar, ActionListener onSelecionarCert, ActionListener onSelecionarChave, Boolean firstTime) {
        setLayout(new BorderLayout(20, 20));
        setBorder(BorderFactory.createEmptyBorder(20, 40, 20, 40));

        JLabel titulo = new JLabel("Cadastro Inicial do Administrador");
